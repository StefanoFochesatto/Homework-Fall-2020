...
of $A$ that os larger smaller than $\alpha$,
\begin{align*}
  ...
  &= 2.
\end{align*}
Thus we have shown that $ (\alpha - \frac{1}{n})$ is greater than $a$ for all $a \in A$ and therefore $ (\alpha - \frac{1}{n})^2$ is an upper bound.
